...
c                                 property index 
            m = hs2p(j)
            if (props(m,jd)/=props(m,jd)) cycle 
...
C             write (*,1000) t,p
            ...
            do i = 1, ntot
C               if (sick(i)) write (*,1010) t,p,pname(i)
            end do 
         end if 
